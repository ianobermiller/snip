...
public static class Mvc {
    public static Snip.Controllers.SnippetController Snippet = new Snip.Controllers.T4MVC_SnippetController();
    public static Snip.Controllers.StatsController Stats = new Snip.Controllers.T4MVC_StatsController();
    public static Snip.Controllers.UserController User = new Snip.Controllers.T4MVC_UserController();
...
namespace Links {
    ...
    public static class Scripts {
        ...
        public static readonly string NameControl_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/NameControl.min.js") ? Url("NameControl.min.js")+"?"+T4Extensions.TimestampString(URLPATH + "/NameControl.js") : Url("NameControl.js")+"?"+T4Extensions.TimestampString(URLPATH + "/NameControl.js");
    ...
    public static class Content {
        ...
        public static class font {
            ...
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            public static readonly string fontawesome_webfont_eot = Url("fontawesome-webfont.eot")+"?"+T4Extensions.TimestampString(URLPATH + "/fontawesome-webfont.eot");
            public static readonly string fontawesome_webfont_svg = Url("fontawesome-webfont.svg")+"?"+T4Extensions.TimestampString(URLPATH + "/fontawesome-webfont.svg");
            public static readonly string fontawesome_webfont_ttf = Url("fontawesome-webfont.ttf")+"?"+T4Extensions.TimestampString(URLPATH + "/fontawesome-webfont.ttf");
            public static readonly string fontawesome_webfont_woff = Url("fontawesome-webfont.woff")+"?"+T4Extensions.TimestampString(URLPATH + "/fontawesome-webfont.woff");
            public static readonly string FontAwesome_otf = Url("FontAwesome.otf")+"?"+T4Extensions.TimestampString(URLPATH + "/FontAwesome.otf");
        }
    
        public static readonly string font_awesome_min_css = Url("font-awesome.min.css")+"?"+T4Extensions.TimestampString(URLPATH + "/font-awesome.min.css");
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public static class Images {
            ...
            public static readonly string linebg_png = Url("linebg.png")+"?"+T4Extensions.TimestampString(URLPATH + "/linebg.png");
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public static class presence {
                private const string URLPATH = "~/Content/Images/presence";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string presence_16_away_png = Url("presence_16-away.png")+"?"+T4Extensions.TimestampString(URLPATH + "/presence_16-away.png");
                public static readonly string presence_16_block_png = Url("presence_16-block.png")+"?"+T4Extensions.TimestampString(URLPATH + "/presence_16-block.png");
                public static readonly string presence_16_busy_png = Url("presence_16-busy.png")+"?"+T4Extensions.TimestampString(URLPATH + "/presence_16-busy.png");
                public static readonly string presence_16_dnd_png = Url("presence_16-dnd.png")+"?"+T4Extensions.TimestampString(URLPATH + "/presence_16-dnd.png");
                public static readonly string presence_16_idle_busy_png = Url("presence_16-idle-busy.png")+"?"+T4Extensions.TimestampString(URLPATH + "/presence_16-idle-busy.png");
                public static readonly string presence_16_idle_online_png = Url("presence_16-idle-online.png")+"?"+T4Extensions.TimestampString(URLPATH + "/presence_16-idle-online.png");
                public static readonly string presence_16_off_png = Url("presence_16-off.png")+"?"+T4Extensions.TimestampString(URLPATH + "/presence_16-off.png");
                public static readonly string presence_16_online_png = Url("presence_16-online.png")+"?"+T4Extensions.TimestampString(URLPATH + "/presence_16-online.png");
                public static readonly string presence_16_unknown_png = Url("presence_16-unknown.png")+"?"+T4Extensions.TimestampString(URLPATH + "/presence_16-unknown.png");
            }
